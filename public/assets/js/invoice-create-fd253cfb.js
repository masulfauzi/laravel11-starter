import{f as r}from"./app-e81b91f2.js";/* empty css            */const l=document.querySelector("#table-products"),o=document.querySelector("#btn-add-item"),n=document.querySelectorAll(".btn-remove-item"),i=`
  <tr>
    <td>
